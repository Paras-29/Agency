    ...
    <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-blue-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute -top-20 -right-20 w-40 h-40 bg-blue-800/20 rounded-full blur-xl"
        />
        <motion.div
          animate={{
            scale: [1.2, 1, 1.2],
          ...
          className="absolute -bottom-20 -left-20 w-32 h-32 bg-indigo-800/20 rounded-full blur-xl"
        />
      </div>
          ...
          <div className="lg:col-span-2">
            ...
            >
              <motion.h3
                ...
                className="text-3xl font-black bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 bg-clip-text text-transparent mb-6"
              >
                TechVision Pro
              </motion.h3>
      ...
      >
        {contact.text}
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h4 className="text-lg font-black mb-6 text-white">Services</h4>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h4 className="text-lg font-black mb-6 text-white">Legal</h4>
            <ul className="space-y-3">
        ...
        >
          ...
          <p className="text-gray-400 text-sm">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              onClick={scrollToTop}
              className="group bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white p-4 rounded-2xl shadow-lg hover:shadow-xl hover:shadow-blue-500/25 transition-all duration-300"
            >
