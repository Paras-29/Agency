            ...
            >
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">hello@techvisionpro.com</span>
                </div>
                <div className="flex items-center space-x-3">
        ...
        >
          <div className="text-center">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Get the latest insights on digital trends, web development tips, and marketing strategies delivered to your inbox.
            </p>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            >
              © {new Date().getFullYear()} TechVision Pro. All rights reserved.
            </motion.div>
